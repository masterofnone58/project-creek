  ...
  `);
          ...
          f2 = function(a12, b10, c3, d3, e3, f3) {
            ...
            null == (g2 = "lookup" === c3.localeMatcher ? function(a13, b11, c4) {
              ...
              let d4, e4, f4 = [], g3 = b11.reduce((a14, b12) => {
                ...
                return e5.matchedSupportedLocale && 0 === d5 || (a14.forEach((a15, c6) => {
      ...
      let b3 = function(a10) {
        ...
        return function(a11) {
          ...
          let f2 = e2.replace(/\\/g, "%5C").replace(/\/+/g, "/"), { domain: g2, locale: h2 } = (b10 = a11.headers, c3 = a11.cookies, d2.domains ? function(a12, b11, c4, d3) {
          ...
          function m2(b11, c4) {
            var e3;
            let f3 = new URL(b11, a11.url);
            if (f3.pathname = bv(f3.pathname), j2.length > 0 && !c4 && g2) {
              let a12 = bK(g2, h2, j2);
              a12 && (c4 = a12.domain, a12.defaultLocale === h2 && "as-needed" === d2.localePrefix.mode && (f3.pathname = bE(f3.pathname, d2.locales, d2.localePrefix)));
            }
            return c4 && (f3.host = c4, a11.headers.get("x-forwarded-host")) && (f3.protocol = a11.headers.get("x-forwarded-proto") ?? a11.nextUrl.protocol, f3.port = c4.split(":")[1] ?? a11.headers.get("x-forwarded-port") ?? ""), a11.nextUrl.basePath && (e3 = f3.pathname, f3.pathname = bv(a11.nextUrl.basePath + e3)), t2 = true, T.redirect(f3.toString());
          }
          let n2 = bE(f2, d2.locales, d2.localePrefix), o2 = bG(f2, d2.locales, d2.localePrefix, g2), p2 = null != o2, q2 = "never" === d2.localePrefix.mode || i2 && "as-needed" === d2.localePrefix.mode, r2, s2, t2, u2 = n2, v2 = d2.pathnames;
          if (v2) {
            let b11;
            if ([b11, s2] = function(a12, b12, c4) {
              ...
              let c4 = v2[s2], e3 = bu(c4, h2, s2);
              if (bw(e3, n2)) u2 = bD(n2, e3, s2);
              else {
                let f3;
                f3 = b11 ? bu(c4, b11, s2) : s2;
                let g3 = q2 ? void 0 : bx(h2, d2.localePrefix);
                r2 = m2(bH(bD(n2, f3, e3), g3, a11.nextUrl.search));
              }
            }
          }
          if (!r2) if ("/" !== u2 || p2) {
            let b11 = bH(u2, `/${h2}`, a11.nextUrl.search);
            if (p2) {
              let c4 = bH(n2, o2.prefix, a11.nextUrl.search);
              if ("never" === d2.localePrefix.mode) r2 = m2(bH(n2, void 0, a11.nextUrl.search));
              else if (o2.exact) if (i2 && q2) r2 = m2(bH(n2, void 0, a11.nextUrl.search));
              else if (d2.domains) {
                let a12 = bK(g2, o2.locale, j2);
                r2 = g2?.domain === a12?.domain || k2 ? l2(b11) : m2(c4, a12?.domain);
              } else r2 = l2(b11);
              else r2 = m2(c4);
            } else r2 = q2 ? l2(b11) : m2(bH(n2, bx(h2, d2.localePrefix), a11.nextUrl.search));
          } else r2 = q2 ? l2(bH(u2, `/${h2}`, a11.nextUrl.search)) : m2(bH(n2, bx(h2, d2.localePrefix), a11.nextUrl.search));
          return function(a12, b11, c4, d3, e3) {
          ...
          }(a11, r2, h2, d2, g2), !t2 && "never" !== d2.localePrefix.mode && d2.alternateLinks && d2.locales.length > 1 && r2.headers.set("Link", function({ internalTemplateName: a12, localizedPathnames: b11, request: c4, resolvedLocale: d3, routing: e3 }) {
            ...
            let j3 = bF(e3.locales, e3.localePrefix, false).flatMap(([a13, c5]) => {
              ...
              if (e3.domains) return e3.domains.filter((b12) => bJ(a13, b12)).map((b12) => ((d4 = new URL(f3)).port = "", d4.host = b12.domain, d4.pathname = i3(f3.pathname, a13), a13 === b12.defaultLocale && "always" !== e3.localePrefix.mode || (d4.pathname = g4(d4.pathname)), h3(d4, a13)));
              {
                let c6;
      ...
      }({ locales: ["zh-CN", "en"], defaultLocale: "zh-CN", localeDetection: false }), b4 = { matcher: ["/((?!api|_next/static|_next/image|favicon.ico).*)"] };
...
var NextConfig = { "env": {}, "eslint": { "ignoreDuringBuilds": false }, "typescript": { "ignoreBuildErrors": false, "tsconfigPath": "tsconfig.json" }, "typedRoutes": false, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.ts", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [16, 32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 60, "formats": ["image/webp"], "maximumResponseBody": 5e7, "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "remotePatterns": [], "unoptimized": false }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "amp": { "canonicalBase": "" }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "serverRuntimeConfig": {}, "publicRuntimeConfig": {}, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": {}, "compiler": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "/Users/ansonshen/Claude/project creek", "allowedDevOrigins": ["*.trycloudflare.com", "192.168.31.149"], "experimental": { "useSkewCookie": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 30, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 4294967294 } }, "cacheHandlers": {}, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "serverSourceMaps": false, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "clientSegmentCache": false, "clientParamParsing": false, "dynamicOnHover": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "middlewarePrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 9, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "imgOptSkipMetadata": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "viewTransition": false, "routerBFCache": false, "removeUncaughtErrorAndRejectionListeners": false, "validateRSCRequestHeaders": false, "staleTimes": { "dynamic": 0, "static": 300 }, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "cacheComponents": false, "inlineCss": false, "useCache": false, "globalNotFound": false, "devtoolSegmentExplorer": true, "browserDebugInfoInTerminal": false, "optimizeRouterScrolling": false, "middlewareClientMaxBodySize": 10485760, "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-sqlite-node", "@effect/sql-sqlite-bun", "@effect/sql-sqlite-wasm", "@effect/sql-sqlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "[\\w-]+-Google|Google-[\\w-]+|Chrome-Lighthouse|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti|googleweblight", "bundlePagesRouterDependencies": false, "configFileName": "next.config.ts", "turbopack": { "root": "/Users/ansonshen/Claude/project creek" } };
var BuildId = "5SxaML7bt7XW4MvXFF2qB";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }], "dynamic": [{ "page": "/[locale]", "regex": "^/([^/]+?)(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)(?:/)?$" }, { "page": "/[locale]/companies", "regex": "^/([^/]+?)/companies(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/companies(?:/)?$" }, { "page": "/[locale]/companies/[company]/dashboard", "regex": "^/([^/]+?)/companies/([^/]+?)/dashboard(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale", "nxtPcompany": "nxtPcompany" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/companies/(?<nxtPcompany>[^/]+?)/dashboard(?:/)?$" }, { "page": "/[locale]/companies/[company]/finance", "regex": "^/([^/]+?)/companies/([^/]+?)/finance(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale", "nxtPcompany": "nxtPcompany" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/companies/(?<nxtPcompany>[^/]+?)/finance(?:/)?$" }, { "page": "/[locale]/companies/[company]/hr", "regex": "^/([^/]+?)/companies/([^/]+?)/hr(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale", "nxtPcompany": "nxtPcompany" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/companies/(?<nxtPcompany>[^/]+?)/hr(?:/)?$" }, { "page": "/[locale]/companies/[company]/inventory", "regex": "^/([^/]+?)/companies/([^/]+?)/inventory(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale", "nxtPcompany": "nxtPcompany" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/companies/(?<nxtPcompany>[^/]+?)/inventory(?:/)?$" }, { "page": "/[locale]/companies/[company]/production", "regex": "^/([^/]+?)/companies/([^/]+?)/production(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale", "nxtPcompany": "nxtPcompany" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/companies/(?<nxtPcompany>[^/]+?)/production(?:/)?$" }, { "page": "/[locale]/companies/[company]/reports", "regex": "^/([^/]+?)/companies/([^/]+?)/reports(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale", "nxtPcompany": "nxtPcompany" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/companies/(?<nxtPcompany>[^/]+?)/reports(?:/)?$" }, { "page": "/[locale]/companies/[company]/sales", "regex": "^/([^/]+?)/companies/([^/]+?)/sales(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale", "nxtPcompany": "nxtPcompany" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/companies/(?<nxtPcompany>[^/]+?)/sales(?:/)?$" }, { "page": "/[locale]/dashboard", "regex": "^/([^/]+?)/dashboard(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/dashboard(?:/)?$" }, { "page": "/[locale]/supply-chain", "regex": "^/([^/]+?)/supply\\-chain(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/supply\\-chain(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/_not-found": { "initialStatus": 404, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_not-found", "dataRoute": "/_not-found.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "3a1d8436c928540ac1951e8a2df4ccc7", "previewModeSigningKey": "2fb6e91967f6e9eb3d41a727f67ef34fb4506c1445f5ffe0aa387d90071900db", "previewModeEncryptionKey": "acbd0839add61cf22574b2371703643f32f78bb8de1121d75fe796ba4c9b04fb" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api|_next\\/static|_next\\/image|favicon.ico).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!api|_next/static|_next/image|favicon.ico).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "5SxaML7bt7XW4MvXFF2qB", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "5eK3SU3ZrFewbrPTVlsOQMoOZU2wLFgcTZXmtilSLwU=", "__NEXT_PREVIEW_MODE_ID": "3a1d8436c928540ac1951e8a2df4ccc7", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "2fb6e91967f6e9eb3d41a727f67ef34fb4506c1445f5ffe0aa387d90071900db", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "acbd0839add61cf22574b2371703643f32f78bb8de1121d75fe796ba4c9b04fb" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/production/route": "/api/production", "/api/inventory/route": "/api/inventory", "/api/reports/route": "/api/reports", "/api/hr/route": "/api/hr", "/api/finance/route": "/api/finance", "/api/sales/route": "/api/sales", "/[locale]/companies/page": "/[locale]/companies", "/[locale]/dashboard/page": "/[locale]/dashboard", "/[locale]/supply-chain/page": "/[locale]/supply-chain", "/[locale]/companies/[company]/(dashboard)/hr/page": "/[locale]/companies/[company]/hr", "/[locale]/companies/[company]/(dashboard)/sales/page": "/[locale]/companies/[company]/sales", "/[locale]/page": "/[locale]", "/[locale]/companies/[company]/(dashboard)/dashboard/page": "/[locale]/companies/[company]/dashboard", "/[locale]/companies/[company]/(dashboard)/reports/page": "/[locale]/companies/[company]/reports", "/[locale]/companies/[company]/(dashboard)/inventory/page": "/[locale]/companies/[company]/inventory", "/[locale]/companies/[company]/(dashboard)/finance/page": "/[locale]/companies/[company]/finance", "/[locale]/companies/[company]/(dashboard)/production/page": "/[locale]/companies/[company]/production" };
